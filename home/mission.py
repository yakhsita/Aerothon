...
def process_lidar(scan):
    ...
    front_distance = clean(ranges[300:340])
    front_left_distance = clean(ranges[360:420])
    front_right_distance = clean(ranges[220:280])
    left_distance = clean(ranges[470:550])
    right_distance = clean(ranges[90:170])
